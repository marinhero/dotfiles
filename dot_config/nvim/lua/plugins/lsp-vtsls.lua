  ...
  opts = {
    servers = {
      ...
      vtsls = {
        ...
        -- ✅ MIGRATED: Use on_init instead of on_attach for client-only setup
        on_init = function(client)
          -- Register custom command for move to file refactoring
    ...
    setup = {
      ...
      vtsls = function(_, opts)
        -- Ensure JavaScript settings inherit from TypeScript settings
